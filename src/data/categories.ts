...
export const CATEGORIES: Record<string, CategoryInfo> = {
  vip: {
    ...
    textColor: '#14532d',
    borderColor: '#16a34a',
    description: 'Chief guests, Ministry officials, Deans, Director & Guest of Honor (Rows A-D Center, 52 seats)',
    defaultCount: 52,
    priority: 1,
  ...
  reporters: {
    ...
    textColor: '#0c4a6e',
    borderColor: '#0284c7',
    description: 'Accredited journalists, press photographers & videographers (Rows E-G Center, 39 seats)',
    defaultCount: 39,
    priority: 2,
  ...
  mbbs: {
    ...
    textColor: '#082f49',
    borderColor: '#0284c7',
    description: 'MBBS Graduating Batch 2020 (Left Wing Front Rows A-R, 119 seats)',
    defaultCount: 119,
    priority: 3,
    recommendedGate: 'Gate-2',
    isCustom: false,
  ...
  nursing: {
    ...
    textColor: '#831843',
    borderColor: '#db2777',
    description: 'B.Sc (Hons) Nursing & M.Sc Nursing Graduates (Left Wing Rows R-X & Balcony, 66 seats)',
    defaultCount: 66,
    priority: 4,
  ...
  pg: {
    ...
    textColor: '#7c2d12',
    borderColor: '#ea580c',
    description: 'MD / MS / MDS Postgraduate Residents (Left Balcony, 19 seats)',
    defaultCount: 19,
    priority: 5,
    recommendedGate: 'Gate-2 or Balcony Gate',
    isCustom: false,
  ...
  pdcc: {
    ...
    textColor: '#581c87',
    borderColor: '#9333ea',
    description: 'Post-Doctoral Certificate Course & Senior Fellows (Balcony Center, 20 seats)',
    defaultCount: 20,
    priority: 6,
  ...
  accompanying: {
    ...
    textColor: '#312e81',
    borderColor: '#4f46e5',
    description: 'Parents, family members & guardians of graduating students (Right Wing Rows A-X, 201 seats)',
    defaultCount: 201,
    priority: 7,
  ...
  senior_faculty: {
    id: 'senior_faculty',
    name: 'Registrar & Senior Leadership',
    shortName: 'Senior Leadership',
    color: '#fdba74',       // Warm Amber
    textColor: '#7c2d12',
    borderColor: '#ea580c',
    description: 'Registrar, Academic Deans & Executive Council',
    defaultCount: 30,
    priority: 9,
    recommendedGate: 'Gate-2',
    isCustom: false,
  ...
  awardees: {
    ...
    textColor: '#701a75',
    borderColor: '#c026d3',
    description: 'Prize winners, Gold medalists & Presenters',
    defaultCount: 35,
    priority: 10,
    recommendedGate: 'Gate-1',
    isCustom: false,
  ...
  band_party: {
    ...
    textColor: '#78350f',
    borderColor: '#d97706',
    description: 'Military / Institutional band musicians and choir (Upper Center Tier, 39 seats)',
    defaultCount: 39,
    priority: 11,
    recommendedGate: 'Balcony Gate',
    isCustom: false,
  ...
  console: {
    ...
    textColor: '#164e63',
    borderColor: '#0891b2',
    description: 'Audio-visual operators, sound engineers, lighting & live stream control',
    defaultCount: 25,
    priority: 12,
    recommendedGate: 'Gate-2',
    isCustom: false,
