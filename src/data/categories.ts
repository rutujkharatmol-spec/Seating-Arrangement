...
export const CATEGORIES: Record<string, CategoryInfo> = {
  vip: {
    ...
    textColor: '#14532d',
    borderColor: '#16a34a',
    description: 'Chief guests, Ministry officials, Deans, Director & Guest of Honor (Center Rows C-G & Right Rows D-E, 79 seats)',
    defaultCount: 79,
    priority: 1,
  ...
  reporters: {
    ...
    textColor: '#0c4a6e',
    borderColor: '#0284c7',
    description: 'Accredited journalists, press photographers & videographers (Right Wing Rows B-C, 14 seats)',
    defaultCount: 14,
    priority: 2,
  ...
  mbbs: {
    ...
    textColor: '#082f49',
    borderColor: '#0284c7',
    description: 'MBBS Graduating Batch 2020 (Left Wing Rows E-U, 119 seats)',
    defaultCount: 119,
    priority: 3,
  ...
  nursing: {
    ...
    textColor: '#831843',
    borderColor: '#db2777',
    description: 'B.Sc (Hons) Nursing & M.Sc Nursing Graduates (Upper Left, Upper Center UB1 & Lower Left Rows V-X, 66 seats)',
    defaultCount: 66,
    priority: 4,
  ...
  pg: {
    ...
    textColor: '#7c2d12',
    borderColor: '#ea580c',
    description: 'MD / MS / MDS Postgraduate Residents (Upper Center Balcony Rows UB1-UB2, 16 seats)',
    defaultCount: 16,
    priority: 5,
  ...
  pdcc: {
    ...
    textColor: '#581c87',
    borderColor: '#9333ea',
    description: 'Post-Doctoral Certificate Course & Senior Fellows (Upper Center Balcony Rows UB3-UB5, 36 seats)',
    defaultCount: 36,
    priority: 6,
    recommendedGate: 'Balcony Gate',
    isCustom: false,
  ...
  accompanying: {
    ...
    textColor: '#312e81',
    borderColor: '#4f46e5',
    description: 'Parents, family members & guardians of graduating students (Upper Right & Right Wing Rows I-X, 147 seats)',
    defaultCount: 147,
    priority: 7,
    recommendedGate: 'Gate-1',
    isCustom: false,
  ...
  faculty: {
    ...
    textColor: '#713f12',
    borderColor: '#ca8a04',
    description: 'Professors, Associate/Assistant Professors & Teaching Staff (Center Rows H-W, 208 seats)',
    defaultCount: 208,
    priority: 8,
    recommendedGate: 'Gate-1 or Gate-2',
    isCustom: false,
  ...
  admin_staff: {
    ...
    shortName: 'administrative staff',
    color: '#fdba74',       // Warm Orange / Peach
    textColor: '#7c2d12',
    borderColor: '#ea580c',
    description: 'Administrative officers, section officers and executive staff (Right Wing Rows F-H, 21 seats)',
    defaultCount: 21,
    priority: 9,
    recommendedGate: 'Gate-1',
    isCustom: false,
  ...
  awardees: {
    ...
    textColor: '#701a75',
    borderColor: '#c026d3',
    description: 'Gold medalists, distinction holders & academic prize winners (Left Wing Row B, 7 seats)',
    defaultCount: 7,
    priority: 10,
    recommendedGate: 'Gate-2',
    isCustom: false,
  ...
  it_staff: {
    ...
    textColor: '#78350f',
    borderColor: '#d97706',
    description: 'Information technology and network transmission operations team (Left Wing Rows C-D, 14 seats)',
    defaultCount: 14,
    priority: 11,
    recommendedGate: 'Gate-2',
    isCustom: false,
  ...
  console: {
    ...
    textColor: '#164e63',
    borderColor: '#0891b2',
    description: 'Audio-visual operators, sound engineers, lighting & live stream control (Left Wing Row A, 5 seats)',
    defaultCount: 5,
    priority: 12,
    recommendedGate: 'Gate-2',
    isCustom: false,
  ...
  audience: {
    id: 'audience',
    name: 'General Audience & Guests',
    shortName: 'Audience',
    color: '#d8b4fe',       // Soft Lavender / Purple
    textColor: '#581c87',
    borderColor: '#9333ea',
    description: 'Hospital staff, trainees and registered general attendees',
    defaultCount: 0,
    priority: 13,
    recommendedGate: 'Gate-1 or Gate-2',
    isCustom: false,
  ...
  blocked: {
    ...
    textColor: '#881337',
    borderColor: '#e11d48',
    description: 'Front 5 seats on Right Wing Row A blocked for stage camera crane / buffer',
    defaultCount: 5,
    priority: 14,
    recommendedGate: 'N/A',
    isCustom: false,
